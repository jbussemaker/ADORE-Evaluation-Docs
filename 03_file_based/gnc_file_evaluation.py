...
if __name__ == '__main__':
    ...
    evaluator = GNCFileEvaluator.from_file('../gnc.adore', save_to_project=True)
    ...
    evaluator.to_file('outputs/gnc_file_evaluation.adore')
    evaluator.save_results_csv('outputs/gnc_file_evaluation.csv')
    GNCCalculator.plot_results(evaluator.get_results(), 'JSON File Evaluator')
